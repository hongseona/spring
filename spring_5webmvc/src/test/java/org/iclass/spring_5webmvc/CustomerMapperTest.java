...
import org.iclass.spring_3mybatis.SpringBootTest;
import org.iclass.spring_3mybatis.Test;
...
@Slf4j
@Transactional      // 스프링부트에서 트랜젝션 관리를 하는 어노테이션. Test 할 때에는 테스트 끝나면 rollback
...
public class CustomerMapperTest {
    ...
    void update() {
        int result = customerMapper.update
            (CustomerDto.builder().customerId("jjangu").age(24).email("jj@naver.com").build());
     ...
     * 만약에 테스트 데이터를 테이블에 반영시키고 싶지 않다면 틀랜젝션 관리 어노테이션을 사용
     * 
