...
public class TestController_5ModelAttribute {
    ...
    // @ModelAttribute 는 단일 파라미터에서는 잘 사용하지 ❌, 주로 여러개 필드를 묶은 dto 에서 사용

    @GetMapping("/product/search2")
    public String search2(@ModelAttribute ProductDto dto) {   // 기본 애트리뷰트 이름은 productDto, 이름 변경은 name = "dto" 와 같이 합니다.
    ...
    public String pcod_list(Model model) {
