...
public class APICommentsController {
  ...
  public ResponseEntity<?> commentSave(@RequestBody CommunityCommentsDto dto) {
  ...
  public ResponseEntity<List<CommunityCommentsDto>> commentsList(@PathVariable int mref) {
