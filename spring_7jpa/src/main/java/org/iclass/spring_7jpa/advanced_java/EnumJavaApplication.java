...
public class EnumJavaApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("Day values: " + Day.values());
		...
		System.out.println("값 4의 요일은? " + Day2.fromNumber(4));	// THURSDAY
		System.out.println("값 8의 요일은? " + Day2.fromNumber(8));	// (IllegalArgumentException) 해당번호의 요일이 없습니다
 ...
 * 서로 관련된 '상수들의 집합' 을 이름 있는 '타입으로 정의'할 떄 사용하는 자료형입니다.
 * 즉, 의미 있는 이름을 가진 "값 목록"을 정의.
 * 상수들만 모여있는 클래스(생성자, 메소드 정의)
 * => 활용) 스프링 시큐리티에서 사용자의 역할(권한) 설정할 떄 
